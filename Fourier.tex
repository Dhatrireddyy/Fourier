...
\begin{document}
	...
	\begin{lstlisting}
		wget https://github.com/Dhatrireddyy/Fourier/blob/main/codes/1.1.py
	\end{lstlisting}
...
Download the following Python code that plots Fig. \ref{fig-2.3}.
	\begin{lstlisting}
		wget https://github.com/Dhatrireddyy/Fourier/blob/main/codes/2.3.py
	\end{lstlisting}
...
\solution Download the following Python code that plots Fig. \ref{fig-2.6}.
	\begin{lstlisting}
		wget https://github.com/Dhatrireddyy/Fourier/blob/main/codes/2.6.py
	\end{lstlisting}
...
Download the following Python code that plots Fig. \ref{fig-3.8}.
	\begin{lstlisting}
		wget https://github.com/Dhatrireddyy/Fourier/blob/main/codes/3.8.py
	\end{lstlisting}
...
Download the following Python code that plots Fig. \ref{fig-3.9}.
	\begin{lstlisting}
		wget https://github.com/Dhatrireddyy/Fourier/blob/main/codes/3.9.py
	\end{lstlisting}
...
Download the following Python code that plots Fig. \ref{fig-3.10}.
	\begin{lstlisting}
		wget https://github.com/Dhatrireddyy/Fourier/blob/main/codes/3.10.py
	\end{lstlisting}
...
Download the following Python code that plots Fig. \ref{fig-4.3}.
	\begin{lstlisting}
		wget https://github.com/Dhatrireddyy/Fourier/blob/main/codes/4.3.py
	\end{lstlisting}
...
\begin{lstlisting}
		wget https://github.com/Dhatrireddyy/circuits/blob/main/codes/5.3.cir
		wget https://github.com/Dhatrireddyy/circuits/blob/main/codes/5.3.py
	\end{lstlisting}
...
\begin{lstlisting}
		wget https://github.com/Dhatrireddyy/circuits/blob/main/codes/5.4.cir
		wget https://github.com/Dhatrireddyy/circuits/blob/main/codes/5.4.py
	\end{lstlisting}
